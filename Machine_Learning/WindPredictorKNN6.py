...
def MarvellousClassifier(DataPath):
    ...
    X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=0.5, random_state=42, stratify=Y) # Value changed
    ...
    model = KNeighborsClassifier(n_neighbors=9) # Changed the value
    ...
    print("Modle accuracy is: ", accuracy*100)
